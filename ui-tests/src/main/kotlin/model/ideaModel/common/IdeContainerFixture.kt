...
open class IdeContainerFixture(
    ...
    inline fun jbList(containsItem: String, function: JBListFixture.() -> Unit = {}): JBListFixture {
    ...
    inline fun jDialog(title: String, function: IdeContainerFixture.() -> Unit = {}): IdeContainerFixture {
